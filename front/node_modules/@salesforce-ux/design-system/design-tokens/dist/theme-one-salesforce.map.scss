...
$theme-one-salesforce-map: (
  ...
  'color-background-primary': (rgb(243, 243, 243)),
  ...
  'color-contrast-secondary': (rgb(243, 243, 243)),
  ...
  'color-background-temp-modal': (rgb(147, 147, 147)),
  ...
  'color-text-tertiary': (rgb(147, 147, 147)),
  ...
  'table-color-background-header': (rgb(243, 243, 243)),
  ...
  'page-header-color-border': (rgb(201, 201, 201)),
  ...
  // Input disabled text
  'color-text-input-disabled': (rgb(68, 68, 68)),
  ...
  'color-text-tab-label': (rgb(24, 24, 24)),
  // Icon color for a button that has a parent element that has a hover state. This is the default text/icon color for that button before its parent has been hovered over.
